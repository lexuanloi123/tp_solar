...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p>Chúng tôi sẽ gửi cho bạn một email để kích hoạt việc đặt lại mật khẩu.</p><?php // @codingStandardsIgnoreLine ?>
	...
	<p class="full_sb_pass woocommerce-form-row form-row">
